    <div class="box">
        ...
        <p class="question">My pastes arent expiring!</p>
        <p class="answer">Paste expiration is not yet complete, but the expiration data is already saved in the database. This effectively means that your pastes will start to expire as soon as the functionality is implemented, but until then people will be able to read them.</p>
    </div>
